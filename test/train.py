...
if __name__ == "__main__":
    ...
    for i in range(episode):
        epsilon = np.interp(i, [0, 40_000], [epsilon_max, epsilon_min])
        ...
        if len(relay_buffer) > 10_000 and i % 2_000 == 0:
            ...
            if i % 10_000 == 0:
                torch.save(agent.policy_net.state_dict(), f"./model/model_{i}.pth")
                torch.save(agent.policy_net.state_dict(), f"./model/model.pth")
